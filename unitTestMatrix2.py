...
class Matrix:
    ...
    def add_elementwise(self, other):
        ...
        result = Matrix(self.rows, self.cols)
        result.elements = array.array('i', [a for a in self.elements])
...
#         self.assertEqual(transposed_matrix.tolist(), [[1, 4], [2, 5], [3, 6]])
    ...
    def test_scalar_multiplication_elementwise(self):
        matrix = Matrix(2, 3, [[1, 2, 3], [4, 5, 6]])
